          ...
          <div className="row">
            <div className="col-md-12 ">
              <div className="card bg-dark text-white">
                <img
                  className="card-img"
                  src={`https://source.unsplash.com/700x600/?${data.weather[0].main}`}
                  alt="Card image"
                />
                  ...
                  <div className="bg-dark bg-opacity-50 py-3 h-100">
                    ...
                    <div className="d-flex justify-content-around align-items-center ">
                      <div className="overflow-auto">
                        <i className={`fas ${emoji} fa-2x mt-4`}></i>
                        <h1 className="fw-bolder mb-0 mt-2">
                          {temperature} &deg;c
                        </h1>
                        <h2 className="fw-bolder mb-0 mt-3">
                          {data.weather[0].main}
                        </h2>
                        <h1 className="lead mt-2 ">
                          {temperature_min}&deg;c | {temperature_max}&deg;c
                        </h1>
                      </div>
                      <div>
                        <i class="fa-solid fa-temperature-half fa-2x mt-4 mb-2"></i>
                        <h4 className="fw-bolder">
                          Humidity{" "}
                          <i class="fa-solid fa-temperature-empty fa-1x"></i>
                        </h4>
                      ...
                      <div>
                        <i
                          class="fa fa-globe fa-2x mb-2 mt-4"
                          aria-hidden="true"
                        ></i>
                        <h4 className="fw-bolder">
                          Latitude <i class="fa-solid fa-location-dot"></i>
                        </h4>
                        {/* <i className={`fas ${emoji} fa-2x`}></i> */}
                        <h3 className="fw-bolder mb-1">{latitude}</h3>

                        <h4 className="mt-0">
                          Longitude <i class="fa-solid fa-location-dot"></i>
                        </h4>
